...
<div class="form-page">
    <div class="page-header fade-up">
        ...
        <div class="page-header-actions">
            <a href="{{ route('talent.bookings.index') }}" class="btn btn-outline">
    ...
    <div class="booking-details-container">
            ...
            <div class="form-card fade-up">
                ...
                <div class="form-card-body">
                    <div class="info-grid">
                        ...
                        @endif
                        @if($booking->audience_size)
                            <div class="info-item">
                                <label>Audience Size</label>
                                <p>{{ number_format($booking->audience_size) }} people</p>
                            </div>
                        @endif
                    </div>
                    @if($booking->requirements)
                        <div class="info-item full-width">
                            ...
                            <p class="special-requirements">{{ $booking->requirements }}</p>
                        </div>
                    @endif
                </div>
            </div>
        ...
        <div class="actions-column">
            ...
            <div class="form-card fade-up">
                ...
                <div class="form-card-body">
                    <form action="{{ route('talent.bookings.update-status', $booking->id) }}" method="POST">
                        @csrf
                        @method('PATCH')
            ...
            <div class="form-card fade-up">
                ...
                <div class="form-card-body">
                    <form action="{{ route('talent.bookings.update-payment', $booking->id) }}" method="POST">
                        @csrf
                        @method('PATCH')
                        <div class="form-group">
            ...
            <div class="form-card fade-up">
                ...
                <div class="form-card-body">
                    <form action="{{ route('talent.bookings.add-notes', $booking->id) }}" method="POST">
                        @csrf
                        @method('PATCH')
                        <div class="form-group">
