...
<div class="content-page">
    <div class="content-header">
        <div class="content-header-left">
            <h1 class="content-title">Jewellery Products</h1>
            <p class="content-subtitle">Manage catalogue items and availability</p>
        </div>
    </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ url('/user/jewellery/products') }}" class="form-grid" enctype="multipart/form-data">
                @csrf
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="POST" action="{{ url('/user/jewellery/products/' . $product->id) }}" class="inline-form" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                    ...
                                    <form method="POST" action="{{ url('/user/jewellery/products/' . $product->id) }}" class="inline-form" onsubmit="return confirm('Delete this product?');">
                                        @csrf
                                        @method('DELETE')
