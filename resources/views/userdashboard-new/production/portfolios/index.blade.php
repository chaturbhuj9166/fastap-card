...
@section('title', 'Production Portfolio')

@section('dashboard-content')
<div class="content-page">
    <div class="content-header">
        <div class="content-header-left">
            <h1 class="content-title">Production Portfolio</h1>
            <p class="content-subtitle">Showcase your best work</p>
        </div>
    </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ url('/user/production/portfolios') }}" class="form-grid" enctype="multipart/form-data">
                @csrf
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="POST" action="{{ url('/user/production/portfolios/' . $portfolio->id) }}" class="inline-form" onsubmit="return confirm('Delete this portfolio item?');">
                                        @csrf
                                        @method('DELETE')
