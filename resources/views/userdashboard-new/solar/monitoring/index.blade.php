...
@section('title', 'Solar Monitoring')
...
<div class="content-page">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ url('/user/solar/monitoring') }}" class="form-grid">
                @csrf
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="POST" action="{{ url('/user/solar/monitoring/' . $entry->id) }}" class="inline-form" onsubmit="return confirm('Delete this record?');">
                                        @csrf
                                        @method('DELETE')
