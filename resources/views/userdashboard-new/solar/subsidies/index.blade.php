...
@section('title', 'Subsidy Applications')
...
<div class="content-page">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ url('/user/solar/subsidies') }}" class="form-grid" enctype="multipart/form-data">
                @csrf
            ...
            @else
                @foreach($subsidies as $subsidy)
                    <div class="item-card">
                        ...
                        <form method="POST" action="{{ url('/user/solar/subsidies/' . $subsidy->id . '/status') }}" class="form-grid">
                            @csrf
                            <div class="form-group">
                                <label class="form-label">Status</label>
                        ...
                        <form method="POST" action="{{ url('/user/solar/subsidies/' . $subsidy->id) }}" class="inline-form" onsubmit="return confirm('Delete this application?');">
                            @csrf
                            @method('DELETE')
