...
@section('page-title', 'Add Qualification')
@section('breadcrumb', 'Add Qualification')
...
<div class="form-page">
    <div class="page-header fade-up">
        <div class="page-header-content">
            ...
            <p>Add your educational background or certification</p>
        </div>
    ...
    <form action="{{ url('/savequalifiaction') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="form-card fade-up">
            ...
            <div class="form-card-body">
                <div class="form-group">
                    ...
                    <input type="text" id="qualifiaction" name="qualifiaction" value="{{ old('qualifiaction') }}"
                ...
                <div class="form-group">
                    ...
                    <textarea id="description" name="description" rows="4"
                              ...
                              placeholder="Describe your qualification, institution, achievements..." required>{{ old('description') }}</textarea>
                    @error('description')
                        <span class="form-error">{{ $message }}</span>
                    @enderror
                </div>
