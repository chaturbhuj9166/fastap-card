...
<div class="bookings-page">
    <div class="page-header fade-up">
        <div class="page-header-content">
            <h1>My Bookings</h1>
            <p>Manage your client bookings and reservations</p>
        </div>
    </div>
            ...
            @foreach($bookings as $booking)
                <div class="booking-card fade-up">
                    ...
                    <div class="booking-body">
                        ...
                        @if($booking->service_type)
                            <div class="booking-service">
                                ...
                                <span>{{ ucfirst($booking->service_type) }} Service</span>
                            </div>
                        @endif
                        @if($booking->location)
                    ...
                    <div class="booking-actions">
                        <a href="{{ route('user.creative.bookings.show', $booking->id) }}" class="action-btn primary" title="View Details">
    ...
    @else
        <div class="empty-state fade-up">
            ...
            <p>You don't have any bookings yet. Share your packages to start receiving bookings.</p>
        </div>
    @endif
</div>
