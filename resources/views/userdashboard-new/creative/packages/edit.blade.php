...
<div class="form-page">
    ...
    <form action="{{ route('user.creative.packages.update', $package->id) }}" method="POST">
        @csrf
        @method('PUT')
            ...
            <div class="form-card-body">
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <select id="type" name="type" class="form-control @error('type') is-invalid @enderror" required>
                            ...
                            <option value="photography" {{ old('type', $package->type) == 'photography' ? 'selected' : '' }}>Photography</option>
                            <option value="event" {{ old('type', $package->type) == 'event' ? 'selected' : '' }}>Event</option>
                            <option value="combined" {{ old('type', $package->type) == 'combined' ? 'selected' : '' }}>Combined</option>
                        </select>
                        @error('type')
                ...
                <div class="form-group">
                    ...
                    <textarea id="deliverables" name="deliverables" rows="3"
                              ...
                              placeholder="What will clients receive? (e.g., 500+ edited photos, online gallery, prints)">{{ old('deliverables', $package->deliverables) }}</textarea>
                    @error('deliverables')
                        <span class="form-error">{{ $message }}</span>
                    @enderror
