...
<div class="content-page">
    <div class="content-header">
        <div class="content-header-left">
            <h1 class="content-title">Legal Cases</h1>
            <p class="content-subtitle">Register and track case status</p>
        </div>
    </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ url('/user/lawyer/cases') }}" class="form-grid">
                @csrf
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="POST" action="{{ url('/user/lawyer/cases/' . $case->id . '/status') }}" class="inline-form">
                                        @csrf
                                    ...
                                    <form method="POST" action="{{ url('/user/lawyer/cases/' . $case->id) }}" class="inline-form" onsubmit="return confirm('Delete this case?');">
                                        @csrf
                                        @method('DELETE')
