...
<div class="content-page">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ url('/user/education/materials') }}" class="form-grid" enctype="multipart/form-data">
                @csrf
            ...
            @else
                @foreach($materials as $material)
                    <div class="item-card">
                        ...
                        <form method="POST" action="{{ url('/user/education/materials/' . $material->id) }}" class="inline-form" onsubmit="return confirm('Delete this material?');">
                            @csrf
                            @method('DELETE')
