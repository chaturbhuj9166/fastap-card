...
<div class="content-page">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ url('/user/education/courses') }}" class="form-grid">
                @csrf
            ...
            @else
                @foreach($courses as $course)
                    <div class="item-card">
                        ...
                        <form method="POST" action="{{ url('/user/education/courses/' . $course->id) }}" class="form-grid">
                            @csrf
                            @method('PUT')
                            <div class="form-group">
                                <label class="form-label">Course Name</label>
                        ...
                        <form method="POST" action="{{ url('/user/education/courses/' . $course->id) }}" class="inline-form" onsubmit="return confirm('Delete this course?');">
                            @csrf
                            @method('DELETE')
