...
<div class="content-page">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ url('/user/education/tests') }}" class="form-grid">
                @csrf
            ...
            @else
                @foreach($tests as $test)
                    <div class="item-card">
                        ...
                        <form method="POST" action="{{ url('/user/education/tests/' . $test->id) }}" class="inline-form" onsubmit="return confirm('Delete this test?');">
                            @csrf
                            @method('DELETE')
