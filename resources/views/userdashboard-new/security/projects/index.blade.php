...
<div class="content-page">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ url('/user/security/projects') }}" class="form-grid" enctype="multipart/form-data">
                @csrf
            ...
            @else
                @foreach($projects as $project)
                    <div class="item-card">
                        ...
                        <form method="POST" action="{{ url('/user/security/projects/' . $project->id . '/status') }}" class="form-grid">
                            @csrf
                            <div class="form-group">
                        ...
                        <form method="POST" action="{{ url('/user/security/projects/' . $project->id) }}" class="inline-form" onsubmit="return confirm('Delete this project?');">
                            @csrf
                            @method('DELETE')
