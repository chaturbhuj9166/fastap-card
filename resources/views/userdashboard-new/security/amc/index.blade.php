...
<div class="content-page">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ url('/user/security/amc') }}" class="form-grid">
                @csrf
            ...
            @else
                @foreach($amcPlans as $plan)
                    <div class="item-card">
                        ...
                        <form method="POST" action="{{ url('/user/security/amc/' . $plan->id) }}" class="inline-form" onsubmit="return confirm('Delete this AMC plan?');">
                            @csrf
                            @method('DELETE')
