...
<div class="content-page">
    <div class="content-header">
        <div class="content-header-left">
            <h1 class="content-title">Public Services</h1>
            <p class="content-subtitle">Manage citizen services and assistance</p>
        </div>
    </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ url('/user/political/services') }}" class="form-grid">
                @csrf
        ...
        <div class="card-body">
            ...
            @else
                @foreach($services as $service)
                    <div class="item-card">
                        <form method="POST" action="{{ url('/user/political/services/' . $service->id) }}" class="form-grid">
                            @csrf
                            @method('PUT')
                            <div class="form-group">
                                <label class="form-label">Service Name</label>
                        ...
                        <form method="POST" action="{{ url('/user/political/services/' . $service->id) }}" class="inline-form" onsubmit="return confirm('Delete this service?');">
                            @csrf
                            @method('DELETE')
