...
@section('title', 'Political Profiles')

@section('dashboard-content')
<div class="content-page">
    <div class="content-header">
        <div class="content-header-left">
            <h1 class="content-title">Political Profiles</h1>
            <p class="content-subtitle">Manage leadership profile information</p>
        </div>
    </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ url('/user/political/profiles') }}" class="form-grid">
                @csrf
        ...
        <div class="card-body">
            ...
            @else
                @foreach($profiles as $profile)
                    <div class="item-card">
                        <form method="POST" action="{{ url('/user/political/profiles/' . $profile->id) }}" class="form-grid">
                            @csrf
                            @method('PUT')
                            <div class="form-group">
                                <label class="form-label">Party Name</label>
                        ...
                        <form method="POST" action="{{ url('/user/political/profiles/' . $profile->id) }}" class="inline-form" onsubmit="return confirm('Delete this profile?');">
                            @csrf
                            @method('DELETE')
