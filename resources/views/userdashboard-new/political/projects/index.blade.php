...
<div class="content-page">
    <div class="content-header">
        <div class="content-header-left">
            <h1 class="content-title">Development Projects</h1>
            <p class="content-subtitle">Showcase constituency development work</p>
        </div>
    </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ url('/user/political/projects') }}" class="form-grid" enctype="multipart/form-data">
                @csrf
        ...
        <div class="card-body">
            ...
            @else
                @foreach($projects as $project)
                    <div class="item-card">
                        <form method="POST" action="{{ url('/user/political/projects/' . $project->id) }}" class="form-grid" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="form-group">
                                <label class="form-label">Project Name</label>
                        ...
                        <form method="POST" action="{{ url('/user/political/projects/' . $project->id) }}" class="inline-form" onsubmit="return confirm('Delete this project?');">
                            @csrf
                            @method('DELETE')
