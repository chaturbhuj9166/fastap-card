...
<div class="content-page">
    <div class="content-header">
        <div class="content-header-left">
            <h1 class="content-title">Diet Plans</h1>
            <p class="content-subtitle">Create nutrition guidance for members</p>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Add Diet Plan</h3>
        </div>
        <div class="card-body">
            <form method="POST" action="{{ url('/user/fitness/diet-plans') }}" class="form-grid">
                @csrf
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="POST" action="{{ url('/user/fitness/diet-plans/' . $plan->id) }}" class="inline-form">
                                        @csrf
                                        @method('PUT')
                                    ...
                                    <form method="POST" action="{{ url('/user/fitness/diet-plans/' . $plan->id) }}" class="inline-form" onsubmit="return confirm('Delete this plan?');">
                                        @csrf
                                        @method('DELETE')
