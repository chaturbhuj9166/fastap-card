...
<div class="content-page">
    <div class="content-header">
        <div class="content-header-left">
            <h1 class="content-title">Training Programs</h1>
            <p class="content-subtitle">Create and manage fitness programs</p>
        </div>
    </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ url('/user/fitness/programs') }}" class="form-grid">
                @csrf
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="POST" action="{{ url('/user/fitness/programs/' . $program->id) }}" class="inline-form">
                                        @csrf
                                        @method('PUT')
                                    ...
                                    <form method="POST" action="{{ url('/user/fitness/programs/' . $program->id) }}" class="inline-form" onsubmit="return confirm('Delete this program?');">
                                        @csrf
                                        @method('DELETE')
