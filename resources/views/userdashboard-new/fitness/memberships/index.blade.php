...
<div class="content-page">
    <div class="content-header">
        <div class="content-header-left">
            <h1 class="content-title">Membership Plans</h1>
            <p class="content-subtitle">Set up gym and class memberships</p>
        </div>
    </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ url('/user/fitness/memberships') }}" class="form-grid">
                @csrf
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="POST" action="{{ url('/user/fitness/memberships/' . $membership->id) }}" class="inline-form">
                                        @csrf
                                        @method('PUT')
                                    ...
                                    <form method="POST" action="{{ url('/user/fitness/memberships/' . $membership->id) }}" class="inline-form" onsubmit="return confirm('Delete this membership?');">
                                        @csrf
                                        @method('DELETE')
