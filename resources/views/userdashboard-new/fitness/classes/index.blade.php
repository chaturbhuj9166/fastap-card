...
<div class="content-page">
    <div class="content-header">
        <div class="content-header-left">
            <h1 class="content-title">Fitness Classes</h1>
            <p class="content-subtitle">Manage schedules and class capacity</p>
        </div>
    </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ url('/user/fitness/classes') }}" class="form-grid">
                @csrf
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="POST" action="{{ url('/user/fitness/classes/' . $class->id) }}" class="inline-form">
                                        @csrf
                                        @method('PUT')
                                    ...
                                    <form method="POST" action="{{ url('/user/fitness/classes/' . $class->id) }}" class="inline-form" onsubmit="return confirm('Delete this class?');">
                                        @csrf
                                        @method('DELETE')
