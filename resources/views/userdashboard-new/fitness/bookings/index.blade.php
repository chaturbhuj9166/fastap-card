...
<div class="content-page">
    <div class="content-header">
        <div class="content-header-left">
            <h1 class="content-title">Class Bookings</h1>
            <p class="content-subtitle">Manage class inquiries and attendance</p>
        </div>
    </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ url('/user/fitness/bookings') }}" class="form-grid">
                @csrf
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="POST" action="{{ url('/user/fitness/bookings/' . $booking->id . '/status') }}" class="inline-form">
                                        @csrf
                                    ...
                                    <form method="POST" action="{{ url('/user/fitness/bookings/' . $booking->id) }}" class="inline-form" onsubmit="return confirm('Delete this booking?');">
                                        @csrf
                                        @method('DELETE')
