...
<div class="content-page">
    <div class="content-header">
        <div class="content-header-left">
            <h1 class="content-title">Transformations</h1>
            <p class="content-subtitle">Showcase member transformations</p>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Add Transformation</h3>
        </div>
        <div class="card-body">
            <form method="POST" action="{{ url('/user/fitness/transformations') }}" class="form-grid" enctype="multipart/form-data">
                @csrf
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Transformation Gallery</h3>
        </div>
        <div class="card-body">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="POST" action="{{ url('/user/fitness/transformations/' . $transformation->id) }}" class="inline-form" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                    ...
                                    <form method="POST" action="{{ url('/user/fitness/transformations/' . $transformation->id) }}" class="inline-form" onsubmit="return confirm('Delete this entry?');">
                                        @csrf
                                        @method('DELETE')
