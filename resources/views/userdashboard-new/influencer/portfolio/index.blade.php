...
<div class="content-page">
    <div class="content-header">
        <div class="content-header-left">
            ...
            <p class="content-subtitle">Showcase your best collaborations and content</p>
        </div>
    </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ url('/user/influencer/portfolio') }}" class="form-grid" enctype="multipart/form-data">
                @csrf
            ...
            @else
                @foreach($portfolio as $item)
                    <div class="item-card">
                        ...
                        <form method="POST" action="{{ url('/user/influencer/portfolio/' . $item->id) }}" class="form-grid" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="form-group">
                                <label class="form-label">Content Type</label>
                        ...
                        <form method="POST" action="{{ url('/user/influencer/portfolio/' . $item->id) }}" class="inline-form" onsubmit="return confirm('Delete this item?');">
                            @csrf
                            @method('DELETE')
