...
<div class="content-page">
    <div class="content-header">
        <div class="content-header-left">
            ...
            <p class="content-subtitle">Track your social media reach by platform</p>
        </div>
    </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ url('/user/influencer/stats') }}" class="form-grid">
                @csrf
            ...
            @else
                @foreach($stats as $stat)
                    <div class="item-card">
                        ...
                        <form method="POST" action="{{ url('/user/influencer/stats/' . $stat->id) }}" class="form-grid">
                            @csrf
                            @method('PUT')
                            <div class="form-group">
                                <label class="form-label">Platform</label>
                        ...
                        <form method="POST" action="{{ url('/user/influencer/stats/' . $stat->id) }}" class="inline-form" onsubmit="return confirm('Delete this stat entry?');">
                            @csrf
                            @method('DELETE')
