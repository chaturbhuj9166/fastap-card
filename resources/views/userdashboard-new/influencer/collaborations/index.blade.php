...
<div class="content-page">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ url('/user/influencer/collaborations') }}" class="form-grid">
                @csrf
            ...
            @else
                @foreach($collaborations as $collaboration)
                    <div class="item-card">
                        ...
                        <form method="POST" action="{{ url('/user/influencer/collaborations/' . $collaboration->id) }}" class="form-grid">
                            @csrf
                            @method('PUT')
                            <div class="form-group">
                                <label class="form-label">Brand Name</label>
                        ...
                        <form method="POST" action="{{ url('/user/influencer/collaborations/' . $collaboration->id) }}" class="inline-form" onsubmit="return confirm('Delete this collaboration?');">
                            @csrf
                            @method('DELETE')
