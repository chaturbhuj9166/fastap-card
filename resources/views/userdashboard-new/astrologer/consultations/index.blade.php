...
<div class="content-page">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ url('/user/astrologer/consultations') }}" class="form-grid">
                @csrf
            ...
            @else
                @foreach($consultations as $consultation)
                    <div class="item-card">
                        ...
                        <form method="POST" action="{{ url('/user/astrologer/consultations/' . $consultation->id . '/status') }}" class="form-grid">
                            @csrf
                            <div class="form-group">
                                <label class="form-label">Status</label>
                        ...
                        <form method="POST" action="{{ url('/user/astrologer/consultations/' . $consultation->id) }}" class="inline-form" onsubmit="return confirm('Delete this consultation?');">
                            @csrf
                            @method('DELETE')
