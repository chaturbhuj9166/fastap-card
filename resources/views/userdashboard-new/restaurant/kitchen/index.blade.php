...
<div class="content-page">
    <div class="content-header">
        <div class="content-header-left">
            <h1 class="content-title">Kitchen Display</h1>
            <p class="content-subtitle">Live incoming orders</p>
        </div>
    </div>
    ...
    <div class="kitchen-grid">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Room Service</h3>
            </div>
            <div class="card-body">
...
<style>
    ...
    .kitchen-notes { margin-top: 0.5rem; font-size: 0.85rem; color: var(--text-secondary); }
