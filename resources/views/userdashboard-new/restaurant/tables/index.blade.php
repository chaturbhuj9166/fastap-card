...
<div class="content-page">
    <div class="content-header">
        <div class="content-header-left">
            <h1 class="content-title">Restaurant Tables</h1>
            <p class="content-subtitle">Create and manage table QR codes</p>
        </div>
    </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ url('/user/restaurant/tables') }}" class="form-grid">
                @csrf
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="POST" action="{{ url('/user/restaurant/tables/' . $table->id) }}" class="inline-form">
                                        @csrf
                                        @method('PUT')
                                        ...
                                        <input type="number" name="seating_capacity" class="form-input form-input-sm" value="{{ $table->seating_capacity }}" min="0">
                                    ...
                                    <form method="POST" action="{{ url('/user/restaurant/tables/' . $table->id . '/qr') }}" class="inline-form">
                                        @csrf
                                        <button type="submit" class="btn btn-sm btn-secondary">Regenerate QR</button>
                                    </form>
                                    <form method="POST" action="{{ url('/user/restaurant/tables/' . $table->id) }}" class="inline-form" onsubmit="return confirm('Delete this table?');">
                                        @csrf
                                        @method('DELETE')
