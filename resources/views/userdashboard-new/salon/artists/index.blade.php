...
@section('title', 'Salon Artists')

@section('dashboard-content')
<div class="content-page">
    <div class="content-header">
        <div class="content-header-left">
            <h1 class="content-title">Salon Artists</h1>
            <p class="content-subtitle">Manage stylists and makeup artists</p>
        </div>
    </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ url('/user/salon/artists') }}" class="form-grid" enctype="multipart/form-data">
                @csrf
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="POST" action="{{ url('/user/salon/artists/' . $artist->id) }}" class="inline-form" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                    ...
                                    <form method="POST" action="{{ url('/user/salon/artists/' . $artist->id) }}" class="inline-form" onsubmit="return confirm('Delete this artist?');">
                                        @csrf
                                        @method('DELETE')
