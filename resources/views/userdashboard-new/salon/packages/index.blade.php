...
@section('title', 'Salon Packages')

@section('dashboard-content')
<div class="content-page">
    <div class="content-header">
        <div class="content-header-left">
            <h1 class="content-title">Salon Packages</h1>
            <p class="content-subtitle">Create packages and offers</p>
        </div>
    </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ url('/user/salon/packages') }}" class="form-grid">
                @csrf
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="POST" action="{{ url('/user/salon/packages/' . $package->id) }}" class="inline-form">
                                        @csrf
                                        @method('PUT')
                                    ...
                                    <form method="POST" action="{{ url('/user/salon/packages/' . $package->id) }}" class="inline-form" onsubmit="return confirm('Delete this package?');">
                                        @csrf
                                        @method('DELETE')
