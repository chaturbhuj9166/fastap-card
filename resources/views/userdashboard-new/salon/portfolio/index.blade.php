...
@section('title', 'Salon Portfolio')

@section('dashboard-content')
<div class="content-page">
    <div class="content-header">
        <div class="content-header-left">
            <h1 class="content-title">Salon Portfolio</h1>
            <p class="content-subtitle">Showcase before/after transformations</p>
        </div>
    </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ url('/user/salon/portfolio') }}" class="form-grid" enctype="multipart/form-data">
                @csrf
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="POST" action="{{ url('/user/salon/portfolio/' . $item->id) }}" class="inline-form" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                    ...
                                    <form method="POST" action="{{ url('/user/salon/portfolio/' . $item->id) }}" class="inline-form" onsubmit="return confirm('Delete this item?');">
                                        @csrf
                                        @method('DELETE')
