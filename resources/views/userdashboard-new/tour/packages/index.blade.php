...
<div class="content-page">
    <div class="content-header">
        <div class="content-header-left">
            ...
            <p class="content-subtitle">Create and manage travel packages</p>
        </div>
    </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ url('/user/tour/packages') }}" class="form-grid" enctype="multipart/form-data">
                @csrf
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="POST" action="{{ url('/user/tour/packages/' . $package->id) }}" class="inline-form" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                    ...
                                    <form method="POST" action="{{ url('/user/tour/packages/' . $package->id) }}" class="inline-form" onsubmit="return confirm('Delete this package?');">
                                        @csrf
                                        @method('DELETE')
