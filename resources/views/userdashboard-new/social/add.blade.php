...
@section('page-title', 'Add Social Links')
@section('breadcrumb', 'Add Social Links')
...
<div class="social-form-page">
    ...
    <form action="{{ url('/savesocial') }}" method="POST" class="social-form">
        @csrf

        <div class="form-card fade-up">
            <div class="form-card-header">
                <h3><i class="fas fa-share-alt"></i> Social Media Profiles</h3>
                <p>Add links to your social media accounts. Leave blank any you don't want to include.</p>
            </div>
                ...
                <div class="social-inputs-grid">
                    ...
                    <div class="social-input-group">
                        ...
                        <div class="social-input-field">
                            ...
                            <input type="url" id="linkdin" name="linkdin" value="{{ old('linkdin') }}"
                    ...
                    <div class="social-input-group">
                        ...
                        <div class="social-input-field">
                            ...
                            <input type="url" id="snapchat" name="snapchat" value="{{ old('snapchat') }}"
                    ...
                    <div class="social-input-group">
                        ...
                        <div class="social-input-field">
                            ...
                            <input type="url" id="pinterest" name="pinterest" value="{{ old('pinterest') }}"
                    ...
                    <div class="social-input-group">
                        ...
                        <div class="social-input-field">
                            ...
                            <input type="url" id="google_review" name="google_review" value="{{ old('google_review') }}"
