...
@section('title', 'Interior Portfolio')

@section('dashboard-content')
<div class="content-page">
    <div class="content-header">
        <div class="content-header-left">
            <h1 class="content-title">Interior Portfolio</h1>
            <p class="content-subtitle">Showcase your best projects</p>
        </div>
    </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ url('/user/interior/portfolio') }}" class="form-grid" enctype="multipart/form-data">
                @csrf
        ...
        <div class="card-body">
            ...
            @else
                @foreach($portfolioItems as $item)
                    <div class="item-card">
                        <form method="POST" action="{{ url('/user/interior/portfolio/' . $item->id) }}" class="form-grid" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="form-group">
                                <label class="form-label">Project Title</label>
                        ...
                        <form method="POST" action="{{ url('/user/interior/portfolio/' . $item->id) }}" class="inline-form" onsubmit="return confirm('Delete this item?');">
                            @csrf
                            @method('DELETE')
