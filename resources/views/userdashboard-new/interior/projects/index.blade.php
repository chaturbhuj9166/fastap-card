...
@section('title', 'Interior Projects')

@section('dashboard-content')
<div class="content-page">
    <div class="content-header">
        <div class="content-header-left">
            <h1 class="content-title">Interior Projects</h1>
            <p class="content-subtitle">Manage client projects and timelines</p>
        </div>
    </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ url('/user/interior/projects') }}" class="form-grid" enctype="multipart/form-data">
                @csrf
        ...
        <div class="card-body">
            ...
            @else
                @foreach($projects as $project)
                    <div class="item-card">
                        <form method="POST" action="{{ url('/user/interior/projects/' . $project->id) }}" class="form-grid" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="form-group">
                                <label class="form-label">Client Name</label>
                        ...
                        <form method="POST" action="{{ url('/user/interior/projects/' . $project->id) }}" class="inline-form" onsubmit="return confirm('Delete this project?');">
                            @csrf
                            @method('DELETE')
