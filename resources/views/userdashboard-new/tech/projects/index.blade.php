...
@section('title', 'Tech Projects')

@section('dashboard-content')
<div class="content-page">
    <div class="content-header">
        <div class="content-header-left">
            <h1 class="content-title">Tech Projects</h1>
            <p class="content-subtitle">Track inquiries and delivery stages</p>
        </div>
    </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ url('/user/tech/projects') }}" class="form-grid">
                @csrf
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="POST" action="{{ url('/user/tech/projects/' . $project->id . '/status') }}" class="inline-form">
                                        @csrf
                                    ...
                                    <form method="POST" action="{{ url('/user/tech/projects/' . $project->id) }}" class="inline-form" onsubmit="return confirm('Delete this project?');">
                                        @csrf
                                        @method('DELETE')
