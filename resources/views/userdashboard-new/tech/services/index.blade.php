...
@section('title', 'Tech Services')

@section('dashboard-content')
<div class="content-page">
    <div class="content-header">
        <div class="content-header-left">
            <h1 class="content-title">Tech Services</h1>
            <p class="content-subtitle">Manage service categories and pricing models</p>
        </div>
    </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ url('/user/tech/services') }}" class="form-grid">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="pricing_model" class="form-input" placeholder="fixed/hourly/monthly">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="delivery_time" class="form-input">
                </div>
                ...
                <div class="form-group full-width">
                    ...
                    <textarea name="technology_stack" class="form-input" rows="3"></textarea>
                </div>
                <div class="form-group full-width">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $service->pricing_model ?? '-' }} {{ $service->base_price ? ' - ' . number_format($service->base_price, 2) : '' }}</td>
                                <td>{{ $service->is_active ? 'Active' : 'Inactive' }}</td>
                                <td>
                                    <form method="POST" action="{{ url('/user/tech/services/' . $service->id) }}" class="inline-form">
                                        @csrf
                                        @method('PUT')
                                        ...
                                        <input type="text" name="pricing_model" class="form-input form-input-sm" value="{{ $service->pricing_model }}">
                                    ...
                                    <form method="POST" action="{{ url('/user/tech/services/' . $service->id) }}" class="inline-form" onsubmit="return confirm('Delete this service?');">
                                        @csrf
                                        @method('DELETE')
