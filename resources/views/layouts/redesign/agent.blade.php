...
@section('content')
    <div class="dashboard-wrapper">
        <!-- Agent Sidebar -->
        @include('layouts.redesign.partials.sidebar-agent')
                ...
                <div class="dashboard-header-left">
                    ...
                    <div>
                        ...
                        <nav class="breadcrumb">
                            <a href="{{ url('/agent/dashboard') }}">Agent</a>
                ...
                <div class="dashboard-header-right">
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu">
                            <a href="{{ url('/agent/myprofile') }}" class="dropdown-item">
                                <i class="fas fa-user"></i>
                                <span>My Profile</span>
                            </a>
                            <div class="dropdown-divider"></div>
                            <a href="{{ url('/agent/logout') }}" class="dropdown-item">
