                      ...
                      <div class="card_inner_main">
                          <div class="class_inner_card">
                              ...
                              <a href="editmyproduct{{$settingee->id}}">
                                <img src="{{url('frontend/myproducts/products-img-icon.png')}}" width="70" />
                              </a>
                       ...
                       <div class="card_ulist">
                              <ul>
                                  <li>
                                      <a href="editmyproduct{{$settingee->id}}"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</a>
                                  </li>
                                  <li><a href="deletemyproduct{{$settingee->id}}" onclick="return confirm('Are you sure?')"><i class="fa fa-trash" aria-hidden="true"></i> Delete</a></li>
                              </ul>
                          </div>
                  </div>
              </div>
