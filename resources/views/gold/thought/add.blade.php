    ...
    <div class="container-fluid">
      ...
      <!--</ol>-->
		<div class="box_general padding_bottom">
			...
			<form action="savethought" method="post" enctype="multipart/form-data">
				 @csrf
			<div class="row">
				<div class="col-md-6">
					<div class="form-group">
						<label>Thought Title</label>
						<input type="text" class="form-control" value="{{old('thought')}}" name="thought" placeholder="Thought Title">
					</div>
