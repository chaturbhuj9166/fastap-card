          ...
          <div class="col-md-8 mb-3">
              <div class="row">
                  <div class="col-6 mb-3">
                      ...
                      <input type="text" name="heading" class="form-control" style="background:white !important;color:black !important" value="{{isset($heading) && $heading->client !='' ? $heading->client : ''}}">
                  </div>
			...
			$blocks = DB::table('clients')->where('uid',$uid)->get();
			@endphp
                  ...
                  <div class="card_table_data">
                      <div class="card_inner_main">
                       ...
                       <div class="card_ulist">
                              <ul>
                                  <li>
                                      <a href="edit_client/{{$b->id}}"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</a>
                                  </li>
                                  <li><a href="delete_client/{{$b->id}}" onclick="return confirm('Are you sure?')"><i class="fa fa-trash" aria-hidden="true"></i> Delete</a></li>
