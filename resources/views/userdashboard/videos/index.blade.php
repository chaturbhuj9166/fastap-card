...
@section('page_title','My Video Link')
@section('content')
<style>
...
<div class="container-fluid them_change">
    ...
    <div class="row">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">My Video Link</li>
      </ol>
          ...
          <div class="col-md-8">
              <div class="row">
                  <div class="col-6 mb-3">
                      ...
                      <input type="text" name="heading" class="form-control" style="background:white !important;color:black !important" value="{{isset($heading) && $heading->videos !='' ? $heading->videos : ''}}">
                  </div>
      ...
      <a href="addmyvideo" class="btn btn-primary mb-3"><i class="fa fa-plus" aria-hidden="true"></i></a>
                  ...
                  <div class="card_table_data">
                      <div class="card_inner_main">
                       ...
                       <div class="card_ulist">
                              <ul>
                                  <li>
                                      <a href="editmyvideo{{$settingee->id}}"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</a>
                                  </li>
                                  <li><a href="deletemyvideo{{$settingee->id}}" onclick="return confirm('Are you sure?')"><i class="fa fa-trash" aria-hidden="true"></i> Delete</a></li>
