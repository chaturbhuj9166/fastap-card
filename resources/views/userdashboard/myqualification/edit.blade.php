    ...
    <div class="container-fluid">
      ...
      <!--</ol>-->
		<div class="box_general padding_bottom">
			...
			<form action="updatequalifiaction"  method="post" enctype="multipart/form-data">
				  @csrf
			...
			<div class="row">
				<div class="col-md-6">
					<div class="form-group">
						...
						<input type="text" value="{{$qualification->qualifiaction}}" name="qualifiaction" class="form-control" placeholder="Qualifiaction">
					</div>
			...
			<div class="row">
				...
				<div class="col-md-12">
					<div class="form-group">
						...
						<textarea class="form-control" value="{{$qualification->description}}" name="description" placeholder="Description">{{$qualification->description}}</textarea>
					</div>
