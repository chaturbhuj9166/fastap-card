...
<div class="container-fluid them_change">
    ...
    <div class="row">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">My Social Link</li>
      </ol>
          ...
          <div class="col-md-8">
              <div class="row">
                  <div class="col-6 mb-3">
                      ...
                      <input type="text" name="heading" class="form-control" style="background:white !important;color:black !important" value="{{isset($heading) && $heading->links !='' ? $heading->links : ''}}">
                  </div>
      ...
      <a href="addsocial" class="btn btn-primary mb-3"><i class="fa fa-plus" aria-hidden="true"></i></a>
      <!--<a href="profile" class="btn btn-primary mb-3 float-right">View Profile</a>-->
       @include('layouts.flash-message')
		...
		<div class="card_responsive_inmobile">
		    <div class="row">
		        <?php $i=0;?>
                  @foreach($socials as $settingee)
              <div class="col-md-4">
                  <div class="card_table_data">
                      <div class="card_inner_main">
                          <div class="class_inner_card profile_links">
                              <?php $i++;?>
                              <!--<p>PID: {{$i}}</p>-->
                              <p>{{$settingee->youtube}}</p>
                              <p>{{$settingee->snapchat}}</p>
                              <p>{{$settingee->facebook}}</p>
                              <p>{{$settingee->instagram}}</p>
                              <p>{{$settingee->twitter}}</p>
                              <p>{{$settingee->linkdin}}</p>
                       ...
                       <div class="card_ulist">
                              <ul>
                                  <li>
                                      <a href="editsocial{{$settingee->id}}"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</a>
                                  </li>
                                  <li><a href="deletesocial{{$settingee->id}}" onclick="return confirm('Are you sure?')"><i class="fa fa-trash" aria-hidden="true"></i> Delete</a></li>
