...
<div class="container-fluid them_change">
    ...
    <div class="row">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">My Services List</li>
      </ol>
      <form method="post" action="add_qual_hed">
          ...
          <div class="col-md-8 mb-3">
              <div class="row">
                  <div class="col-6 mb-3">
                      ...
                      <input type="text" name="heading" class="form-control" style="background:white !important;color:black !important" value="{{isset($heading) && $heading->qual !='' ? $heading->service : ''}}">
                  </div>
       ...
       <a href="addprofessions" class="btn btn-primary mb-3"><i class="fa fa-plus" aria-hidden="true"></i></a>
      <!--<a href="profile" class="btn btn-primary mb-3 float-right">View Profile</a>-->
       @include('layouts.flash-message')
		...
		<div class="card_responsive_inmobile">
		    <div class="row">
		         <?php $i=0;?>
                  @foreach($professions as $settingee)
              <div class="col-md-4">
                  <div class="card_table_data">
                      <div class="card_inner_main">
                          <div class="class_inner_card ">
                              <?php $i++;?>
                             {{-- <p>PID: {{$settingee->id}}</p> --}}
                              <h6>{{$settingee->profession}}</h6>
                              <span class="d-flex"><p>{{$settingee->email}}</p></span>
                          </div>
                         {{-- <div class="class_inner_card">
                       ...
                       <div class="card_ulist">
                              <ul>
                                  <li>
                                      <a href="editprofessions{{$settingee->id}}"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</a>
                                  </li>
                                  <li><a href="deleteprofessions{{$settingee->id}}" onclick="return confirm('Are you sure?')"><i class="fa fa-trash" aria-hidden="true"></i> Delete</a></li>
