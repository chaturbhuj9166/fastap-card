		...
		<div class="box_general padding_bottom">
			...
			<div class="row">
				...
				<div class="col-md-6">
					<div class="form-group">
						<label>Price</label>
						<input type="number" class="form-control"  value="{{$myproducts['price']}}" name="price" placeholder="Product Price" >
					</div>
				...
				<div class="col-md-6">
					<div class="form-group">
						...
						<textarea class="form-control"  value="{{$myproducts['sd']}}" name="description" placeholder="Product Description"></textarea>
					</div>
					<p style="color:red;">@error('escription'){{$message}}@enderror</p>
				</div>
