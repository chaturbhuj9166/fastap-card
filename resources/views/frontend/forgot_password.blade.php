...
<html lang="en">
<head>
  <title>Fastap Forgot Password</title>
  <meta charset="utf-8">
   ...
   <div class="container">
      <div class="signin__wrapper">
         <div class="row justify-content-between align-items-center">
            ...
            <h3 class="text-center" style="border-radius: 5px;">Forgot Password Fastap</h3>
            <div class="iner_padding">
                ...
                <div>
                    ...
                    @endif
                  <form method="post" action="{{url('/forgot_password_email')}}">
						@csrf
                     <div class="main">
                         <div id='mobileblock'>
                            <div class="input-group" style="margin-bottom: 10px;">
                              <label style="color:black;">Please enter your email id to continue</label> 
                                <input style="width:100%;margin-top: 10px;" type="email" id="email" name="email" class="form-control" placeholder="Enter email" required/>
                            </div>
                             <button class='btn btn-success mt-2' type='submit'>Send Password Reset Link</button>
                            </div>
                     </div>
                  </form>
