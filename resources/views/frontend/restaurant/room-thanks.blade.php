...
<section class="thanks-page">
    <div class="thanks-card">
        ...
        <p>Your room service request has been submitted.</p>
        <p><strong>Request:</strong> #{{ $order->id }}</p>
...
<style>
    ...
    .btn-primary { display: inline-block; margin-top: 1rem; background: #0f172a; color: #fff; padding: 0.7rem 1.5rem; border-radius: 0.5rem; text-decoration: none; }
</style>
@endsection
