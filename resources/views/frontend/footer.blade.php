...
.social{
    ...
    align-items: center;
    justify-content: center;
    width: 35px;          /* Optional: set width */
    height: 35px;         /* Optional: set height
}
             ...
             <div class="row g-5">
                <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-6">
                   <div class="footer__widget">
                      ...
                      <ul class="social">
                         <li>
                            <a href="https://www.facebook.com/profile.php?id=61551549521517&mibextid=LQQJ4d" class="social__item">
                         ...
                         <li>
                            <a href="https://www.instagram.com/fastap_?igsh=MTR0bTIycmRjd2w2Zw==" class="social__item social__itemtwo">
                               <span class="icon social">
                         ...
                         <li>
                            <a href="https://twitter.com/" target="_blank" class="social__item social__itemthree">
                               <span class="icon social">
                         ...
                         <li>
                            <a href="https://www.linkedin.com/in/" target="_blank" class="social__item social__itemfour">
                               <span class="icon social">
                ...
                <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-6">
                   <div class="footer__widget">
                     ...
                     <div class="widget__link">
                         <a href="{{ url('digital-business-card-in-jaipur') }}/business-card" class="link">
                            BUSINESS CARD
                         </a>
                         <a href="{{ url('digital-business-card-in-jaipur') }}/business-professional-card" class="link">
                            PROFESSIONAL CARD
                         </a>
                         <a href="{{ url('digital-business-card-in-jaipur') }}/premium-card" class="link">
                            PREMIUM  CARD
                         </a>
