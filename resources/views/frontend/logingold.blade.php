            ...
            <div class="col-lg-6">
               <div class="signin__content__left">
                  <div class="signin__head">
                     ...
                     <p>
                        Please enter your email id and password to continue
                     </p>
                  </div>
                   ...
                   <form method="POST" action="/logingolduser/login_gold_store">
                    @csrf
                     ...
                     <div class="row g-4">
                        ...
                        <div class="col-lg-12">
                           <div class="form__grp">
                              ...
                              <input type="password" name="password" id="password" placeholder="Enter Your Password..." required value="{{old('password')}}">
                           </div>
                        </div>
                     </div>
                     ...
                     <!--</div>-->
                     <p class="accout">
                        Do you have an account? <a href="{{url ('/signin')}}">Signup</a><br/>
                     ...
                     <button type="submit" name="submit" class="cmn--btn" style="border:none;background: gold;"> <span>Login</span> </button>
                  </form>
               </div>
            </div>
            <div class="col-lg-5">
