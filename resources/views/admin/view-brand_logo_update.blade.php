...
<a href="{{ url('uploads/product_images/'.$logo->logo)}}" data-fancybox="images" data-caption="This image has a caption">
<img src="{{ url('uploads/product_images/'.$logo->logo)}}" alt="lightbox" class="lightbox-thumb img-thumbnail" style="width: 70px; height: 60px;">
</a
</div>
