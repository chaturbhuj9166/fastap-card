					   ...
					   <div class="card-body">
						   <div class="d-flex align-items-center">
							   <div>
								   ...
								   <h4 class="my-1 text-danger">{{$totalproduct}}</h4>
					   ...
					   <div class="card-body">
						   <div class="d-flex align-items-center">
							   <div>
								   ...
								   <h4 class="my-1 text-success">{{$totalcat}}</h4>
					   ...
					   <div class="card-body">
						   <div class="d-flex align-items-center">
							   <div>
								   ...
								   <h4 class="my-1 text-warning">{{$totalcus}}</h4>
                   ...
                   <div class="col-12 col-lg-12">
                      <div class="card radius-10">
						  ...
						  <div class="row row-cols-1 row-cols-md-3 row-cols-xl-3 g-0 row-group text-center border-top">
							<div class="col">
							  <div class="p-3">
								<h5 class="mb-0">24.15</h5>
								<small class="mb-0">Overall Visitor Rating<span> <i class="bx bx-up-arrow-alt align-middle"></i> 2.43%</span></small>
							  </div>
							</div>
							<div class="col">
							  <div class="p-3">
