...
<input type="hidden" name="id" value="{{$upadatechildcat['id']}}">
...
<input type="text" class="form-control" value="{{$upadatechildcat['child_categroy']}}" name="childcategory" placeholder="some text" value="">
</div>
...
<input type="hidden" name="logohidden" value="{{$upadatechildcat['image']}}">
<img src="{{('../uploads/Child_categroy/'.$upadatechildcat->image)}}" alt="lightbox" class="lightbox-thumb img-thumbnail" style="width: 70px; height: 35px;">
</div>
</div>
</div>
...
<div class="col-sm-9">
<div class="input-group mb-3">
<textarea name="editor" >{{$upadatechildcat['description']}}</textarea>
</div>
</div>
</div>
