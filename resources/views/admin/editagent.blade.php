...
<h6 class="mb-0 text-uppercase">Edit Franchise</h6>
...
<form class="row g-3 " action="/admin/editagent/{{$agent->id}}/agentupdate" method="post" enctype="multipart/form-data">
    @csrf
    @method('PUT')
    ...
    <input type="text" name="mobile" value="{{old('mobile' ,$agent->mobile)}}" class="form-control" >
    <p style="color:red;">@error('mobile'){{$message}}@enderror</p>
    </div>
    
    <div class="col-md-6">
    <label  class="form-label">Alternative Mobile</label>
    <input type="text" name="alternative_mobile" value="{{old('alternative_mobile' ,$agent->alternative_mobile)}}" class="form-control" >
    <p style="color:red;">@error('alternative_mobile'){{$message}}@enderror</p>
    </div>
    
    <div class="col-md-6">
    <label  class="form-label">Address</label>
    <input type="text" name="address" value="{{old('address' ,$agent->address)}}" class="form-control" >
    ...
    <input type="text" name="email" value="{{old('email' ,$agent->email)}}" class="form-control" >
    <p style="color:red;">@error('email'){{$message}}@enderror</p>
    </div>
    
    <div class="col-md-6">
    <label  class="form-label">Password</label>
    <input type="password" name="password" value="{{old('password' ,$agent->password)}}" class="form-control" >
    <p style="color:red;">@error('password'){{$message}}@enderror</p>
    </div>
    
    <div class="col-md-6">
    <label  class="form-label">Franchise Code</label>
    <input type="text" name="agent_code" value="{{old('agent_code' ,$agent->agent_code)}}" class="form-control" >
