           ...
           <div class="col-lg-12">
		     <div class="card">
			   <div class="card-header text-uppercase"> Testimonial</div>
			     <div class="card-body">
				    <form method="POSt" action="updatetestimonial" class="form-horizontal" enctype="multipart/form-data">
                    @csrf
					    ...
					    <div class="form-group row">
						  ...
						  <div class="col-sm-4">
							<div class="input-group mb-3">
								...
								<input type="text" class="form-control" value="{{$testimonial->name}}" name="name" placeholder="name" value="">
							  </div>
						  ...
						  <label for="basic-input" class="col-sm-2 col-form-label">Image</label>
							...
							<div class="input-group mb-3">
								...
								<textarea type="text" class="form-control" value="" name="description" placeholder="Description" value="">{{$testimonial->description}}</textarea>
							  </div>
