...
<div class="col-lg-12">
<div class="card">
<div class="card-header"><i class="fa fa-table"></i>subscribers<a style="float: right;" class="btn btn-primary" href="addtestimonial"><i class="fa fa-plus-circle" style="margin-right: 0;" aria-hidden="true"></i></a></div>
<div class="card-body">
...
<a class="btn btn-danger" href="subscribersdelete{{$settingee->id}}" onclick="return confirm('Are you sure?')"><i class="fa fa-trash-o"></i></a>
</td>
@endforeach
</tbody>
