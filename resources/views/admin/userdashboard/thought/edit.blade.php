...
<div class="page-wrapper">
	<div class="page-content">
	    ...
	    <div class="row">
           <div class="col-lg-12">
		     <div class="card">
			   <div class="card-header text-uppercase">Edit Thought</div>
			     <div class="card-body">
				    <form method="POSt" action="updatethought" class="form-horizontal" enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="id" value="{{$thought->id}}"></input>
					    <div class="form-group row">
						  <label for="basic-input" class="col-sm-2 col-form-label">Thought</label>
						  <div class="col-sm-4">
							<div class="input-group mb-3">
                            
								<input type="text" class="form-control" value="{{$thought->thought}}" name="thought" placeholder="Thought">
							  </div>
						  ...
						  <label for="basic-input" class="col-sm-2 col-form-label">Description</label>
							...
							<div class="input-group mb-3">
								...
								<textarea type="text" class="form-control" value="{{$thought->description}}" name="description" placeholder="Description">{{$thought->description}}</textarea>
							  </div>
