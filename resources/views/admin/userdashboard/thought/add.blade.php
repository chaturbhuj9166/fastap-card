...
<div class="page-wrapper">
	    ...
	    <div class="row">
           <div class="col-lg-12">
		     <div class="card">
			   <div class="card-header text-uppercase"> Thought</div>
			     <div class="card-body">
				    <form method="POSt" action="savethought" class="form-horizontal" enctype="multipart/form-data">
                        @csrf

					    <div class="form-group row">
						  <label for="basic-input" class="col-sm-2 col-form-label">Thought Title</label>
						  <div class="col-sm-4">
							<div class="input-group mb-3">
                            
								<input type="text" class="form-control" value="{{old('thought')}}" name="thought" placeholder="thought">
							  </div>
