...
<div class="page-wrapper">
	<div class="page-content">
	    ...
	    <div class="row">
           <div class="col-lg-12">
		     <div class="card">
			   <div class="card-header text-uppercase">Edit Portfolio</div>
			     <div class="card-body">
				    <form method="POSt" action="updateportfolio" class="form-horizontal" enctype="multipart/form-data">
                        @csrf
					    ...
					    <div class="form-group row">
						  ...
						  <div class="col-sm-4">
							<div class="input-group mb-3">
								...
								<input type="text" class="form-control" value="{{$portfolio->title}}" name="title" placeholder="Title">
							  </div>
						 ...
						 {{-- <div class="form-group row">
						  ...
						  <label for="basic-input" class="col-sm-2 col-form-label">Description</label>
							...
							<div class="input-group mb-3">
								...
								<textarea type="text" class="form-control" value="{{$portfolio->description}}" name="description" placeholder="Description">{{$portfolio->description}}</textarea>
							  </div>
