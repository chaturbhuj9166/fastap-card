                        ...
                        <?php $i=0;?>
                            @foreach($orders as $settingee)
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-dark" href="userorderview{{$settingee->id }}"><i class="fa fa-eye"></i></a>
                                    <!--<a class="btn btn-danger" onclick="confirm('Are you sure?')" href="orderdelete/{{$settingee->id}}"><i class="fa fa-trash-o"></i></a>-->
