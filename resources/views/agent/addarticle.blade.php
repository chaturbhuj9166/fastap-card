...
@section('main-container')
    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"> Website Managment /</span> Add New Article</h4>
            ...
            <div class="row">
                ...
                <div class="col-xxl">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form method="POST" action="/admin/addarticle/store" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="title" id="title"
                                            placeholder="Enter Internal Title" value="{{ old('title') }}" />
                                        @if ($errors->has('title'))
                                ...
                                <div class="row mb-3">
                                    <label class="col-sm-2 col-form-label" for="short_desc">Short
                                        Description</label>
                                    <div class="col-sm-10">
                                        <textarea rows="6" cols="50"  id="short_desc" name="short_desc" class="form-control"
                                            placeholder="Hi, Do you have a moment to talk Joe?" aria-label="Hi, Do you have a moment to talk Joe?"
                                            aria-describedby="basic-icon-default-message2">{{ old('short_desc') }}</textarea>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="ckeditor form-control" name="long_desc" id="long_desc">{{old('long_desc')}}</textarea>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="date" class="form-control" name="post_date" id="post_date"
                                            placeholder="Enter Internal Title" value="{{ old('post_date') }}" />
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="post_by" id="post_by"
                                            placeholder="Enter Post By" value="{{ old('post_by') }}" />
