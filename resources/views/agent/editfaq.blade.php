...
@section('main-container')
    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"> Website Managment /</span> Edit FAQ</h4>
            ...
            <div class="row">
                ...
                <div class="col-xxl">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form method="POST" action="/admin/editfaq/{{ $faq->id }}/update">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="internal_title" id="internal_title"
                                            ...
                                            value="{{ old('internal_title', $faq->internal_title) }}" />
                                ...
                                <div class="row mb-3">
                                    <label class="col-sm-2 col-form-label" for="internal_description">Internal
                                        Description</label>
                                    <div class="col-sm-10">
                                        <textarea rows="6" cols="50" id="internal_description" name="internal_description" class="form-control"
                                            placeholder="Hi, Do you have a moment to talk Joe?" aria-label="Hi, Do you have a moment to talk Joe?"
                                            aria-describedby="basic-icon-default-message2">{{ old('internal_description', $faq->internal_description) }} </textarea>
