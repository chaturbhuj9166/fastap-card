...
@section('main-container')
    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"> User Managment /</span> Edit User</h4>
                ...
                <div class="col-xxl">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="/admin/edituser/{{ $user->id }}/update" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <input type="text" class="form-control" placeholder="Add Service With Expiry"
                                                id="services" name="services" value="{{ old('services' , $user->services) }}">
                                        ...
                                        <div class="col">
                                            <input type="date" class="form-control" id="services_expiry_date"
                                                name="services_expiry_date" value="{{ old('services_expiry_date' , $user->services_expiry_date) }}">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea rows="6" cols="50" id="description" name="description" class="form-control"
                                            ...
                                            aria-describedby="basic-icon-default-message2">{{ old('description' , $user->description) }}</textarea>
