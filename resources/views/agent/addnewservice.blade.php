...
@section('main-container')
    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"> Services Managment /</span> Add New Service</h4>
                ...
                <div class="col-xxl">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="/admin/addnewservice/store" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control"  name="service_slug" id="service_slug"
                                            placeholder="Enter Service Slug" value="{{old('service_slug')}}"/>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" class="form-control"  name="market_price" id="market_price"
                                            placeholder="Enter Market Price" value="{{old('market_price')}}"/>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" class="form-control"  name="total_profit" id="total_profit"
                                            placeholder="Enter Total Profit" value="{{old('total_profit')}}"/>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="step1" name="step1"
                                            placeholder="Enter Step 1" value="{{old('step1')}}"/>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="step2" name="step2"
                                            placeholder="Enter Step 2" value="{{old('step2')}}"/>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="step3" name="step3"
                                            placeholder="Enter Step 3" value="{{old('step3')}}"/>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="ckeditor form-control" id="document_require" name="document_require">{{old('document_require')}}</textarea>
                                    </textarea>
