...
@section('main-container')
    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"> Category Managment /</span> Edit Sub-Category
            </h4>
                ...
                <div class="col-xxl">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="/admin/editsubcategory/{{ $subcategory->id }}/update"
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select class="form-select" id="category_id" name="category_id">
                                                ...
                                                @foreach ($allcategory as $allcategoryList)
                                                    @if ($subcategory->category_id == $allcategoryList->id)
                                                        <option selected
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="slug" name="sub_category_slug"
                                            placeholder="Enter Slug Name" value="{{ old('sub_category_slug',$subcategory->sub_category_slug) }}" />
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="internal_title" name="internal_title"
                                            ...
                                            value="{{ old('internal_title', $subcategory->internal_title) }}" />
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea rows="8" cols="50" id="internal_desc" name="internal_desc" class="form-control"
                                            ...
                                            aria-describedby="basic-icon-default-message2">{{ old('internal_desc', $subcategory->internal_desc) }}</textarea>
                                        @if ($errors->has('internal_desc'))
                                            <span class="text-danger">
                                                {{ $errors->first('internal_desc', $subcategory->internal_desc) }} </span>
                                        @endif
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="ckeditor form-control" name="overview_desc" id="overview_desc">{{old('overview_desc',$subcategory->overview_desc)}}</textarea>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <a target="_blank"
                                            href='{{ url("frontend/assets/images/about/overview/$subcategory->overview_image") }}'
                                            data-fancybox="images">
                                            <img src='{{ url("frontend/assets/images/about/overview/$subcategory->overview_image") }}'
                                ...
                                <div class="row mb-3">
                                    <label class="col-sm-2 col-form-label" for="pros">Pros</label>
                                    <div class="col-sm-10">
                                        <textarea class="ckeditor form-control" name="pros" id="pros">{{old('pros',$subcategory->pros)}}</textarea>
                                ...
                                <div class="row mb-3">
                                    <label class="col-sm-2 col-form-label" for="cons">Cons</label>
                                    <div class="col-sm-10">
                                        <textarea class="ckeditor form-control" name="cons" id="cons">{{old('cons',$subcategory->cons)}}</textarea>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="ckeditor form-control" name="why_how_desc" id="why_how_desc">{{old('why_how_desc',$subcategory->why_how_desc)}}</textarea>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="file" class="form-control" id="why_how_image"
                                            name="why_how_image" />
                                        @if ($errors->has('why_how_image', $subcategory->why_how_image))
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <a target="_blank"
                                            href='{{ url("frontend/assets/images/about/$subcategory->why_how_image") }}'
                                            data-fancybox="images">
                                            <img src='{{ url("frontend/assets/images/about/$subcategory->why_how_image") }}'
                                                alt="Why Us Image" class="lightbox-thumb img-thumbnail"
                                                style="width: 140px; height: 70px;">
                                        </a>
                                    </div>
