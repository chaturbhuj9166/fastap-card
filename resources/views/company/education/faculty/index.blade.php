...
@section('page-title', 'Education Faculty')
@section('breadcrumb', 'Education Faculty')
...
<div class="content-page">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ url('/company/education/faculty') }}" class="form-grid" enctype="multipart/form-data">
                @csrf
            ...
            @else
                @foreach($faculty as $member)
                    <div class="item-card">
                        ...
                        <form method="POST" action="{{ url('/company/education/faculty/' . $member->id) }}" class="form-grid" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="form-group">
                                <label class="form-label">Faculty Name</label>
                        ...
                        <form method="POST" action="{{ url('/company/education/faculty/' . $member->id) }}" class="inline-form" onsubmit="return confirm('Delete this faculty member?');">
                            @csrf
                            @method('DELETE')
