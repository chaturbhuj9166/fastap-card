...
@section('page-title', 'Education Results')
@section('breadcrumb', 'Education Results')
...
<div class="content-page">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ url('/company/education/results') }}" class="form-grid">
                @csrf
            ...
            @else
                @foreach($results as $result)
                    <div class="item-card">
                        ...
                        <form method="POST" action="{{ url('/company/education/results/' . $result->id) }}" class="inline-form" onsubmit="return confirm('Delete this result?');">
                            @csrf
                            @method('DELETE')
