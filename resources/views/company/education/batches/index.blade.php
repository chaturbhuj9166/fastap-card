...
@section('page-title', 'Education Batches')
@section('breadcrumb', 'Education Batches')
...
<div class="content-page">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ url('/company/education/batches') }}" class="form-grid">
                @csrf
            ...
            @else
                @foreach($batches as $batch)
                    <div class="item-card">
                        ...
                        <form method="POST" action="{{ url('/company/education/batches/' . $batch->id) }}" class="form-grid">
                            @csrf
                            @method('PUT')
                            <div class="form-group">
                                <label class="form-label">Course</label>
                        ...
                        <form method="POST" action="{{ url('/company/education/batches/' . $batch->id) }}" class="inline-form" onsubmit="return confirm('Delete this batch?');">
                            @csrf
                            @method('DELETE')
