...
@section('breadcrumb', 'Admission Applications')
...
<div class="content-page">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ url('/company/education/admissions') }}" class="form-grid">
                @csrf
            ...
            @else
                @foreach($admissions as $admission)
                    <div class="item-card">
                        ...
                        <form method="POST" action="{{ url('/company/education/admissions/' . $admission->id . '/status') }}" class="form-grid">
                            @csrf
                            <div class="form-group">
                        ...
                        <form method="POST" action="{{ url('/company/education/admissions/' . $admission->id) }}" class="inline-form" onsubmit="return confirm('Delete this admission?');">
                            @csrf
                            @method('DELETE')
