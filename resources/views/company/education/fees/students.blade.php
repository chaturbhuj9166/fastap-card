...
@section('breadcrumb', 'Student Fees')
...
<div class="content-page">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ url('/company/education/student-fees') }}" class="form-grid">
                @csrf
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="POST" action="{{ url('/company/education/student-fees/' . $fee->id) }}" class="inline-form" onsubmit="return confirm('Delete this fee record?');">
                                        @csrf
                                        @method('DELETE')
