...
@section('breadcrumb', 'Fee Structures')
...
<div class="content-page">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ url('/company/education/fee-structures') }}" class="form-grid">
                @csrf
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="POST" action="{{ url('/company/education/fee-structures/' . $structure->id) }}" class="inline-form" onsubmit="return confirm('Delete this fee structure?');">
                                        @csrf
                                        @method('DELETE')
