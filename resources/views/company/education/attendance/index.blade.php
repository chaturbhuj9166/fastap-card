...
@section('breadcrumb', 'Class Attendance')
...
<div class="content-page">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ url('/company/education/attendance') }}" class="form-grid">
                @csrf
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $entry->status }}</td>
                                <td>
                                    <form method="POST" action="{{ url('/company/education/attendance/' . $entry->id) }}" class="inline-form" onsubmit="return confirm('Delete this entry?');">
                                        @csrf
                                        @method('DELETE')
