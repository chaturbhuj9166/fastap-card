...
<div class="content-page">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ url('/company/ca/cases') }}" class="form-grid" enctype="multipart/form-data">
                @csrf
            ...
            @else
                @foreach($cases as $case)
                    <div class="item-card">
                        ...
                        <form method="POST" action="{{ url('/company/ca/cases/' . $case->id . '/status') }}" class="form-grid">
                            @csrf
                            <div class="form-group">
                                <label class="form-label">Case Status</label>
                        ...
                        <form method="POST" action="{{ url('/company/ca/cases/' . $case->id) }}" class="inline-form" onsubmit="return confirm('Delete this case?');">
                            @csrf
                            @method('DELETE')
