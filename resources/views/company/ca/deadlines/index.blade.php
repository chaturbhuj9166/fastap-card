...
<div class="content-page">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ url('/company/ca/deadlines') }}" class="form-grid">
                @csrf
            ...
            @else
                @foreach($deadlines as $deadline)
                    <div class="item-card">
                        ...
                        <form method="POST" action="{{ url('/company/ca/deadlines/' . $deadline->id) }}" class="form-grid">
                            @csrf
                            @method('PUT')
                            <div class="form-group">
                                <label class="form-label">Compliance Type</label>
                        ...
                        <form method="POST" action="{{ url('/company/ca/deadlines/' . $deadline->id) }}" class="inline-form" onsubmit="return confirm('Delete this deadline?');">
                            @csrf
                            @method('DELETE')
