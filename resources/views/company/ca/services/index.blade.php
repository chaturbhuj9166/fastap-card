...
<div class="content-page">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ url('/company/ca/services') }}" class="form-grid">
                @csrf
            ...
            @else
                @foreach($services as $service)
                    <div class="item-card">
                        ...
                        <form method="POST" action="{{ url('/company/ca/services/' . $service->id) }}" class="form-grid">
                            @csrf
                            @method('PUT')
                            <div class="form-group">
                                <label class="form-label">Service Category</label>
                        ...
                        <form method="POST" action="{{ url('/company/ca/services/' . $service->id) }}" class="inline-form" onsubmit="return confirm('Delete this service?');">
                            @csrf
                            @method('DELETE')
