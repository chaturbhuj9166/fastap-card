...
@section('page-title', 'Case Hearings')
@section('breadcrumb', 'Case Hearings')
...
<div class="restaurant-page">
    <div class="page-header">
        <div class="page-header-left">
            <h2>Case Hearings</h2>
            <p>Track hearing schedules and outcomes</p>
        </div>
    </div>
    ...
    <div class="settings-card">
        <div class="card-header">
            <h3><i class="fas fa-plus"></i> Add Hearing</h3>
        </div>
        <div class="card-body">
            <form method="POST" action="{{ url('/company/lawyer/hearings') }}" class="form-grid">
                @csrf
    ...
    <div class="settings-card">
        <div class="card-header">
            <h3><i class="fas fa-list"></i> Hearings</h3>
        </div>
        <div class="card-body">
            @if($hearings->count() === 0)
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="POST" action="{{ url('/company/lawyer/hearings/' . $hearing->id) }}" class="inline-form">
                                        @csrf
                                        @method('PUT')
                                    ...
                                    <form method="POST" action="{{ url('/company/lawyer/hearings/' . $hearing->id) }}" class="inline-form" onsubmit="return confirm('Delete this hearing?');">
                                        @csrf
                                        @method('DELETE')
