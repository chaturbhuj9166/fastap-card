...
@section('page-title', 'Salon Products')
@section('breadcrumb', 'Salon Products')
...
<div class="restaurant-page">
    <div class="page-header">
        <div class="page-header-left">
            ...
            <p>Manage retail product offerings</p>
        </div>
    </div>
    ...
    <div class="settings-card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ url('/company/salon/products') }}" class="form-grid" enctype="multipart/form-data">
                @csrf
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="POST" action="{{ url('/company/salon/products/' . $product->id) }}" class="inline-form" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                    ...
                                    <form method="POST" action="{{ url('/company/salon/products/' . $product->id) }}" class="inline-form" onsubmit="return confirm('Delete this product?');">
                                        @csrf
                                        @method('DELETE')
