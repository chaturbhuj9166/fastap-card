...
@section('page-title', 'Salon Appointments')
@section('breadcrumb', 'Salon Appointments')
...
<div class="restaurant-page">
    ...
    <div class="settings-card">
        <div class="card-header">
            <h3><i class="fas fa-plus"></i> Add Appointment</h3>
        </div>
        <div class="card-body">
            <form method="POST" action="{{ url('/company/salon/appointments') }}" class="form-grid">
                @csrf
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="POST" action="{{ url('/company/salon/appointments/' . $appointment->id . '/status') }}" class="inline-form">
                                        @csrf
                                    ...
                                    <form method="POST" action="{{ url('/company/salon/appointments/' . $appointment->id) }}" class="inline-form" onsubmit="return confirm('Delete this appointment?');">
                                        @csrf
                                        @method('DELETE')
