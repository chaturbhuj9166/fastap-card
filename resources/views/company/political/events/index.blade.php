...
@section('page-title', 'Public Events')
@section('breadcrumb', 'Public Events')
...
<div class="restaurant-page">
    <div class="page-header">
        <div class="page-header-left">
            <h2>Public Events</h2>
            <p>Manage meetings and community events</p>
        </div>
    </div>
    ...
    <div class="settings-card">
        <div class="card-header">
            <h3><i class="fas fa-plus"></i> Add Event</h3>
        </div>
        <div class="card-body">
            <form method="POST" action="{{ url('/company/political/events') }}" class="form-grid">
                @csrf
        ...
        <div class="card-body">
            ...
            @else
                @foreach($events as $event)
                    <div class="item-card">
                        <form method="POST" action="{{ url('/company/political/events/' . $event->id) }}" class="form-grid">
                            @csrf
                            @method('PUT')
                            <div class="form-group">
                                <label class="form-label">Event Title</label>
                        ...
                        <form method="POST" action="{{ url('/company/political/events/' . $event->id) }}" class="inline-form" onsubmit="return confirm('Delete this event?');">
                            @csrf
                            @method('DELETE')
