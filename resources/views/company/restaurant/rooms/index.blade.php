...
@section('page-title', 'Hotel Rooms')
@section('breadcrumb', 'Hotel Rooms')
...
<div class="restaurant-page">
    <div class="page-header">
        <div class="page-header-left">
            <h2>Hotel Rooms</h2>
            <p>Manage room QR codes and availability</p>
        </div>
    </div>
    ...
    <div class="settings-card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ url('/company/restaurant/rooms') }}" class="form-grid">
                @csrf
    ...
    <div class="settings-card">
        <div class="card-header">
            <h3><i class="fas fa-list"></i> Rooms</h3>
        </div>
        <div class="card-body">
            @if($rooms->count() === 0)
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="POST" action="{{ url('/company/restaurant/rooms/' . $room->id) }}" class="inline-form">
                                        @csrf
                                        @method('PUT')
                                    ...
                                    <form method="POST" action="{{ url('/company/restaurant/rooms/' . $room->id . '/qr') }}" class="inline-form">
                                        @csrf
                                        <button type="submit" class="btn btn-sm btn-secondary">Regenerate QR</button>
                                    </form>
                                    <form method="POST" action="{{ url('/company/restaurant/rooms/' . $room->id) }}" class="inline-form" onsubmit="return confirm('Delete this room?');">
                                        @csrf
                                        @method('DELETE')
