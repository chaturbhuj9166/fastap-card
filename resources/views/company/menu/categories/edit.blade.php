...
<div class="form-page">
    <div class="form-card">
        <div class="form-header">
            <h2><i class="fas fa-folder-open"></i> Edit Category</h2>
            <p>Update {{ $category->name }}</p>
        </div>

        <form action="{{ route('company.menu.category.update', $category->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <div class="file-upload-area" id="uploadArea">
                        ...
                        <div class="upload-placeholder" id="uploadPlaceholder" style="{{ $category->image ? 'display:none' : '' }}">
                            <i class="fas fa-cloud-upload-alt"></i>
                            <p>Click or drag to upload image</p>
                            <span>Max 2MB, JPG/PNG</span>
                        </div>
                        <div class="upload-preview" id="uploadPreview" style="{{ $category->image ? '' : 'display:none' }}">
                            <img id="previewImage" src="{{ $category->image ? asset('uploads/menu/categories/' . $category->image) : '' }}" alt="Preview">
