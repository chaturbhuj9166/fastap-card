...
<div class="form-page">
    <div class="form-card">
        ...
        <form action="{{ route('company.menu.item.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="name" class="form-input" placeholder="e.g., Chicken Biryani" value="{{ old('name') }}" required>
                </div>

                <div class="form-group">
                    <label class="form-label">Description</label>
                    <textarea name="description" class="form-input" rows="3" placeholder="Describe your dish...">{{ old('description') }}</textarea>
                </div>

                <div class="form-row">
                    <div class="form-group">
                        <label class="form-label">Price (?) *</label>
                        <input type="number" name="price" class="form-input" step="0.01" min="0" placeholder="0.00" value="{{ old('price') }}" required>
                    </div>
                    <div class="form-group">
                        ...
                        <select name="dietary_type" class="form-select" required>
                            ...
                            <option value="non_veg" {{ old('dietary_type') == 'non_veg' ? 'selected' : '' }}>Non-Vegetarian</option>
                            <option value="egg" {{ old('dietary_type') == 'egg' ? 'selected' : '' }}>Contains Egg</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="preparation_time" class="form-input" placeholder="e.g., 20-25 mins" value="{{ old('preparation_time') }}">
                    </div>
                </div>

                <div class="form-group">
                    <label class="form-label">Serves</label>
                    <input type="text" name="serves" class="form-input" placeholder="e.g., 1-2 people" value="{{ old('serves') }}">
                </div>
            </div>
            ...
            <div class="form-section">
                ...
                <div class="checkbox-group">
                    ...
                    <label class="checkbox-label">
                        <input type="checkbox" name="is_chefs_special" value="1" {{ old('is_chefs_special') ? 'checked' : '' }}>
                        <span class="checkmark"></span>
