...
<div class="content-page">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ url('/company/astrologer/reports') }}" class="form-grid" enctype="multipart/form-data">
                @csrf
            ...
            @else
                @foreach($reports as $report)
                    <div class="item-card">
                        ...
                        <form method="POST" action="{{ url('/company/astrologer/reports/' . $report->id) }}" class="inline-form" onsubmit="return confirm('Delete this report?');">
                            @csrf
                            @method('DELETE')
