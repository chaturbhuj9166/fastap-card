...
@section('title', 'Astro Consultations')
...
<div class="content-page">
    <div class="content-header">
        <div class="content-header-left">
            ...
            <p class="content-subtitle">Manage appointments and client details</p>
        </div>
    </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ url('/company/astrologer/consultations') }}" class="form-grid">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="consultation_mode" class="form-input" placeholder="in_person/video/phone">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label class="form-label">Property Address (Vastu)</label>
                    <input type="text" name="property_address" class="form-input">
                </div>
                <div class="form-group">
                    <label class="form-label">Property Direction</label>
                    <input type="text" name="property_direction" class="form-input" placeholder="north/east/west">
                </div>
                <div class="form-group">
            ...
            @else
                @foreach($consultations as $consultation)
                    <div class="item-card">
                        ...
                        <p class="item-desc">
                            {{ $consultation->consultation_mode ?? 'Consultation' }}
                        ...
                        <form method="POST" action="{{ url('/company/astrologer/consultations/' . $consultation->id . '/status') }}" class="form-grid">
                            @csrf
                            <div class="form-group">
                                <label class="form-label">Status</label>
                        ...
                        <form method="POST" action="{{ url('/company/astrologer/consultations/' . $consultation->id) }}" class="inline-form" onsubmit="return confirm('Delete this consultation?');">
                            @csrf
                            @method('DELETE')
