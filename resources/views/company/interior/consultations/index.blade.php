...
@section('page-title', 'Design Consultations')
@section('breadcrumb', 'Design Consultations')
...
<div class="restaurant-page">
    <div class="page-header">
        <div class="page-header-left">
            ...
            <p>Track consultation requests and statuses</p>
        </div>
    </div>
    ...
    <div class="settings-card">
        <div class="card-header">
            <h3><i class="fas fa-plus"></i> Add Consultation</h3>
        </div>
        <div class="card-body">
            <form method="POST" action="{{ url('/company/interior/consultations') }}" class="form-grid">
                @csrf
    ...
    <div class="settings-card">
        <div class="card-header">
            <h3><i class="fas fa-list"></i> Consultations</h3>
        </div>
        <div class="card-body">
            ...
            @else
                @foreach($consultations as $consultation)
                    <div class="item-card">
                        ...
                        <form method="POST" action="{{ url('/company/interior/consultations/' . $consultation->id . '/status') }}" class="form-grid">
                            @csrf
                            <div class="form-group">
                                <label class="form-label">Status</label>
                        ...
                        <form method="POST" action="{{ url('/company/interior/consultations/' . $consultation->id) }}" class="inline-form" onsubmit="return confirm('Delete this consultation?');">
                            @csrf
                            @method('DELETE')
