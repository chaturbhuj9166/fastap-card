...
@section('page-title', 'Interior Services')
@section('breadcrumb', 'Interior Services')
...
<div class="restaurant-page">
    ...
    <div class="settings-card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ url('/company/interior/services') }}" class="form-grid">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="pricing_type" class="form-input" placeholder="fixed/per_sqft/custom">
                </div>
                <div class="form-group">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="POST" action="{{ url('/company/interior/services/' . $service->id) }}" class="inline-form">
                                        @csrf
                                        @method('PUT')
                                        <input type="text" name="service_category" class="form-input form-input-sm" value="{{ $service->service_category }}">
                                    ...
                                    <form method="POST" action="{{ url('/company/interior/services/' . $service->id) }}" class="inline-form" onsubmit="return confirm('Delete this service?');">
                                        @csrf
                                        @method('DELETE')
