...
<div class="content-page">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ url('/company/security/products') }}" class="form-grid" enctype="multipart/form-data">
                @csrf
            ...
            @else
                @foreach($products as $product)
                    <div class="item-card">
                        ...
                        <form method="POST" action="{{ url('/company/security/products/' . $product->id) }}" class="form-grid">
                            @csrf
                            @method('PUT')
                            <div class="form-group">
                                <label class="form-label">Category</label>
                        ...
                        <form method="POST" action="{{ url('/company/security/products/' . $product->id) }}" class="inline-form" onsubmit="return confirm('Delete this product?');">
                            @csrf
                            @method('DELETE')
