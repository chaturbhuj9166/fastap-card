...
<div class="content-page">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ url('/company/security/surveys') }}" class="form-grid" enctype="multipart/form-data">
                @csrf
            ...
            @else
                @foreach($surveys as $survey)
                    <div class="item-card">
                        ...
                        <form method="POST" action="{{ url('/company/security/surveys/' . $survey->id . '/status') }}" class="form-grid">
                            @csrf
                            <div class="form-group">
                        ...
                        <form method="POST" action="{{ url('/company/security/surveys/' . $survey->id) }}" class="inline-form" onsubmit="return confirm('Delete this survey?');">
                            @csrf
                            @method('DELETE')
