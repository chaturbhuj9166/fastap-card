...
@section('breadcrumb', 'Tour Bookings')
...
<div class="restaurant-page">
    <div class="page-header">
        <div class="page-header-left">
            <h2>Tour Bookings</h2>
            <p>Track booking inquiries and confirmations</p>
        </div>
    </div>
    ...
    <div class="settings-card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ url('/company/tour/bookings') }}" class="form-grid">
                @csrf
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="POST" action="{{ url('/company/tour/bookings/' . $booking->id . '/status') }}" class="inline-form">
                                        @csrf
                                    ...
                                    <form method="POST" action="{{ url('/company/tour/bookings/' . $booking->id) }}" class="inline-form" onsubmit="return confirm('Delete this booking?');">
                                        @csrf
                                        @method('DELETE')
