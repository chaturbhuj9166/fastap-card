...
@section('page-title', 'Solar Solutions')
@section('breadcrumb', 'Solar Solutions')
...
<div class="content-page">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ url('/company/solar/solutions') }}" class="form-grid">
                @csrf
            ...
            @else
                @foreach($solutions as $solution)
                    <div class="item-card">
                        ...
                        <form method="POST" action="{{ url('/company/solar/solutions/' . $solution->id) }}" class="form-grid">
                            @csrf
                            @method('PUT')
                            <div class="form-group">
                                <label class="form-label">Solution Name</label>
                        ...
                        <form method="POST" action="{{ url('/company/solar/solutions/' . $solution->id) }}" class="inline-form" onsubmit="return confirm('Delete this solution?');">
                            @csrf
                            @method('DELETE')
