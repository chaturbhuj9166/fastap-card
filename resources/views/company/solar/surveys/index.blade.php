...
@section('page-title', 'Solar Site Surveys')
@section('breadcrumb', 'Solar Site Surveys')
...
<div class="content-page">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ url('/company/solar/surveys') }}" class="form-grid" enctype="multipart/form-data">
                @csrf
            ...
            @else
                @foreach($surveys as $survey)
                    <div class="item-card">
                        ...
                        <form method="POST" action="{{ url('/company/solar/surveys/' . $survey->id . '/status') }}" class="form-grid">
                            @csrf
                            <div class="form-group">
                        ...
                        <form method="POST" action="{{ url('/company/solar/surveys/' . $survey->id) }}" class="inline-form" onsubmit="return confirm('Delete this survey?');">
                            @csrf
                            @method('DELETE')
