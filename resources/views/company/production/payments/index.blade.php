...
@section('page-title', 'Production Payments')
@section('breadcrumb', 'Production Payments')

@section('company-content')
<div class="restaurant-page">
    <div class="page-header">
        <div class="page-header-left">
            <h2>Production Payments</h2>
            <p>Track payment milestones across projects</p>
        </div>
    </div>
    ...
    <div class="settings-card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ url('/company/production/payments') }}" class="form-grid">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="payment_stage" class="form-input">
                </div>
                <div class="form-group">
    ...
    <div class="settings-card">
        <div class="card-header">
            <h3><i class="fas fa-list"></i> Payments</h3>
        </div>
        <div class="card-body">
            @if($payments->count() === 0)
