...
@section('page-title', 'Production Team')
@section('breadcrumb', 'Production Team')
...
<div class="restaurant-page">
    <div class="page-header">
        <div class="page-header-left">
            ...
            <p>Manage crew and specialists</p>
        </div>
    </div>
    ...
    <div class="settings-card">
        <div class="card-header">
            <h3><i class="fas fa-plus"></i> Add Team Member</h3>
        </div>
        <div class="card-body">
            <form method="POST" action="{{ url('/company/production/team') }}" class="form-grid" enctype="multipart/form-data">
                @csrf
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="POST" action="{{ url('/company/production/team/' . $member->id) }}" class="inline-form" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                    ...
                                    <form method="POST" action="{{ url('/company/production/team/' . $member->id) }}" class="inline-form" onsubmit="return confirm('Delete this team member?');">
                                        @csrf
                                        @method('DELETE')
