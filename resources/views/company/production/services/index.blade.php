...
@section('page-title', 'Production Services')
@section('breadcrumb', 'Production Services')
...
<div class="restaurant-page">
    <div class="page-header">
        <div class="page-header-left">
            ...
            <p>Manage services for the production house</p>
        </div>
    </div>
    ...
    <div class="settings-card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ url('/company/production/services') }}" class="form-grid">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="pricing_type" class="form-input">
                </div>
                <div class="form-group">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="POST" action="{{ url('/company/production/services/' . $service->id) }}" class="inline-form">
                                        @csrf
                                        @method('PUT')
                                        ...
                                        <input type="text" name="features" class="form-input form-input-sm" value="{{ is_array($service->features) ? implode(', ', $service->features) : '' }}">
                                        <input type="text" name="sample_work" class="form-input form-input-sm" value="{{ is_array($service->sample_work) ? implode(', ', $service->sample_work) : '' }}">
                                    ...
                                    <form method="POST" action="{{ url('/company/production/services/' . $service->id) }}" class="inline-form" onsubmit="return confirm('Delete this service?');">
                                        @csrf
                                        @method('DELETE')
