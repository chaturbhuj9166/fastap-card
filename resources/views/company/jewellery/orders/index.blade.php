...
@section('breadcrumb', 'Custom Orders')
...
<div class="restaurant-page">
    <div class="page-header">
        <div class="page-header-left">
            <h2>Custom Orders</h2>
            <p>Track bespoke jewellery requests</p>
        </div>
    </div>
    ...
    <div class="settings-card">
        <div class="card-header">
            <h3><i class="fas fa-plus"></i> Add Custom Order</h3>
        </div>
        <div class="card-body">
            <form method="POST" action="{{ url('/company/jewellery/orders') }}" class="form-grid" enctype="multipart/form-data">
                @csrf
    ...
    <div class="settings-card">
        <div class="card-header">
            <h3><i class="fas fa-list"></i> Custom Orders</h3>
        </div>
        <div class="card-body">
            @if($orders->count() === 0)
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="POST" action="{{ url('/company/jewellery/orders/' . $order->id . '/status') }}" class="inline-form">
                                        @csrf
                                    ...
                                    <form method="POST" action="{{ url('/company/jewellery/orders/' . $order->id) }}" class="inline-form" onsubmit="return confirm('Delete this order?');">
                                        @csrf
                                        @method('DELETE')
