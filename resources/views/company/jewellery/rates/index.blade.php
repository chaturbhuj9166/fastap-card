...
@section('page-title', 'Metal Rates')
@section('breadcrumb', 'Metal Rates')
...
<div class="restaurant-page">
    <div class="page-header">
        <div class="page-header-left">
            <h2>Metal Rates</h2>
            <p>Maintain daily gold and silver rates</p>
        </div>
    </div>
    ...
    <div class="settings-card">
        <div class="card-header">
            <h3><i class="fas fa-plus"></i> Add Rate</h3>
        </div>
        <div class="card-body">
            <form method="POST" action="{{ url('/company/jewellery/rates') }}" class="form-grid">
                @csrf
    ...
    <div class="settings-card">
        <div class="card-header">
            <h3><i class="fas fa-list"></i> Rate History</h3>
        </div>
        <div class="card-body">
            @if($rates->count() === 0)
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $rate->city ?? '-' }}</td>
                                <td>
                                    <form method="POST" action="{{ url('/company/jewellery/rates/' . $rate->id) }}" class="inline-form">
                                        @csrf
                                        @method('PUT')
                                    ...
                                    <form method="POST" action="{{ url('/company/jewellery/rates/' . $rate->id) }}" class="inline-form" onsubmit="return confirm('Delete this rate?');">
                                        @csrf
                                        @method('DELETE')
