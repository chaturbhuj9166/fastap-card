...
@section('page-title', 'Jewellery Products')
@section('breadcrumb', 'Jewellery Products')
...
<div class="restaurant-page">
    <div class="page-header">
        <div class="page-header-left">
            ...
            <p>Manage the company jewellery catalogue</p>
        </div>
    </div>
    ...
    <div class="settings-card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ url('/company/jewellery/products') }}" class="form-grid" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="metal_type" class="form-input">
                </div>
                <div class="form-group">
                    <label class="form-label">Metal Purity</label>
                    <input type="text" name="metal_purity" class="form-input">
                </div>
                <div class="form-group">
                    <label class="form-label">Weight (grams)</label>
                    <input type="number" name="weight_grams" class="form-input" step="0.01" min="0">
                </div>
                <div class="form-group">
                    <label class="form-label">Making Charges</label>
                    <input type="number" name="making_charges" class="form-input" step="0.01" min="0">
                </div>
                <div class="form-group">
                ...
                <div class="form-group full-width">
                    <label class="form-label">Stone Details (one per line)</label>
                    <textarea name="stone_details" class="form-input" rows="2"></textarea>
                </div>
                <div class="form-group full-width">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="POST" action="{{ url('/company/jewellery/products/' . $product->id) }}" class="inline-form" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        <input type="text" name="category" class="form-input form-input-sm" value="{{ $product->category }}" required>
                                        <input type="text" name="product_name" class="form-input form-input-sm" value="{{ $product->product_name }}" required>
                                        <input type="text" name="metal_type" class="form-input form-input-sm" value="{{ $product->metal_type }}">
                                    ...
                                    <form method="POST" action="{{ url('/company/jewellery/products/' . $product->id) }}" class="inline-form" onsubmit="return confirm('Delete this product?');">
                                        @csrf
                                        @method('DELETE')
