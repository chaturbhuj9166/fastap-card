...
@section('breadcrumb', 'Case Studies')
...
<div class="restaurant-page">
    <div class="page-header">
        <div class="page-header-left">
            <h2>Case Studies</h2>
            <p>Showcase project results and impact</p>
        </div>
    </div>
    ...
    <div class="settings-card">
        <div class="card-header">
            <h3><i class="fas fa-plus"></i> Add Case Study</h3>
        </div>
        <div class="card-body">
            <form method="POST" action="{{ url('/company/tech/case-studies') }}" class="form-grid" enctype="multipart/form-data">
                @csrf
    ...
    <div class="settings-card">
        <div class="card-header">
            <h3><i class="fas fa-list"></i> Case Studies</h3>
        </div>
        <div class="card-body">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="POST" action="{{ url('/company/tech/case-studies/' . $caseStudy->id) }}" class="inline-form" onsubmit="return confirm('Delete this case study?');">
                                        @csrf
                                        @method('DELETE')
