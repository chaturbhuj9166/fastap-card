...
@section('breadcrumb', 'Member Subscriptions')
...
<div class="restaurant-page">
    <div class="page-header">
        <div class="page-header-left">
            ...
            <p>Track active and expired memberships</p>
        </div>
    </div>
    ...
    <div class="settings-card">
        <div class="card-header">
            <h3><i class="fas fa-plus"></i> Add Subscription</h3>
        </div>
        <div class="card-body">
            <form method="POST" action="{{ url('/company/fitness/subscriptions') }}" class="form-grid">
                @csrf
    ...
    <div class="settings-card">
        <div class="card-header">
            <h3><i class="fas fa-list"></i> Subscriptions</h3>
        </div>
        <div class="card-body">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="POST" action="{{ url('/company/fitness/subscriptions/' . $subscription->id) }}" class="inline-form">
                                        @csrf
                                        @method('PUT')
                                    ...
                                    <form method="POST" action="{{ url('/company/fitness/subscriptions/' . $subscription->id) }}" class="inline-form" onsubmit="return confirm('Delete this subscription?');">
                                        @csrf
                                        @method('DELETE')
