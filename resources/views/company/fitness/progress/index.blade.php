...
@section('page-title', 'Member Progress')
@section('breadcrumb', 'Member Progress')
...
<div class="restaurant-page">
    <div class="page-header">
        <div class="page-header-left">
            ...
            <p>Track assessments and results</p>
        </div>
    </div>
    ...
    <div class="settings-card">
        <div class="card-header">
            <h3><i class="fas fa-plus"></i> Add Progress Entry</h3>
        </div>
        <div class="card-body">
            <form method="POST" action="{{ url('/company/fitness/progress') }}" class="form-grid" enctype="multipart/form-data">
                @csrf
    ...
    <div class="settings-card">
        <div class="card-header">
            <h3><i class="fas fa-list"></i> Progress Entries</h3>
        </div>
        <div class="card-body">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $entry->bmi ?? '-' }}</td>
                                <td>
                                    <form method="POST" action="{{ url('/company/fitness/progress/' . $entry->id) }}" class="inline-form" onsubmit="return confirm('Delete this entry?');">
                                        @csrf
                                        @method('DELETE')
