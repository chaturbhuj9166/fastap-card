...
<div class="restaurant-page">
    <div class="page-header">
        <div class="page-header-left">
            <h2>Trainers</h2>
            <p>Manage instructor profiles</p>
        </div>
    </div>
    ...
    <div class="settings-card">
        <div class="card-header">
            <h3><i class="fas fa-plus"></i> Add Trainer</h3>
        </div>
        <div class="card-body">
            <form method="POST" action="{{ url('/company/fitness/trainers') }}" class="form-grid" enctype="multipart/form-data">
                @csrf
    ...
    <div class="settings-card">
        <div class="card-header">
            <h3><i class="fas fa-list"></i> Trainer List</h3>
        </div>
        <div class="card-body">
            @if($trainers->count() === 0)
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="POST" action="{{ url('/company/fitness/trainers/' . $trainer->id) }}" class="inline-form" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                    ...
                                    <form method="POST" action="{{ url('/company/fitness/trainers/' . $trainer->id) }}" class="inline-form" onsubmit="return confirm('Delete this trainer?');">
                                        @csrf
                                        @method('DELETE')
