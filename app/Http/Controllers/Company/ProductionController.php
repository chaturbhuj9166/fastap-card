...
class ProductionController extends Controller
{
    public function services(Request $request)
    {
        ...
        $services = ProductionService::where('company_id', $company->id)->orderBy('service_name')->get();

        return view('company.production.services.index', compact('company', 'services'));
    }
    ...
    {
        $company = $this->getCompany($request);
        $service = ProductionService::where('company_id', $company->id)->findOrFail($id);
    ...
    {
        $company = $this->getCompany($request);
        $projects = ProductionProject::where('company_id', $company->id)->orderByDesc('created_at')->get();
        $services = ProductionService::where('company_id', $company->id)->orderBy('service_name')->get();

        return view('company.production.projects.index', compact('company', 'projects', 'services'));
    }
    ...
    {
        $company = $this->getCompany($request);
        $project = ProductionProject::where('company_id', $company->id)->findOrFail($id);
    ...
    {
        $company = $this->getCompany($request);
        $portfolios = ProductionPortfolio::where('company_id', $company->id)->orderByDesc('created_at')->get();

        return view('company.production.portfolios.index', compact('company', 'portfolios'));
    }
    ...
    {
        $company = $this->getCompany($request);
        $portfolio = ProductionPortfolio::where('company_id', $company->id)->findOrFail($id);
        $portfolio->delete();
    ...
    {
        $company = $this->getCompany($request);
        $members = ProductionTeam::where('company_id', $company->id)->orderBy('display_order')->get();

        return view('company.production.team.index', compact('company', 'members'));
    }
    ...
    {
        $company = $this->getCompany($request);
        $member = ProductionTeam::where('company_id', $company->id)->findOrFail($id);
    ...
    {
        $company = $this->getCompany($request);
        $payments = ProductionPayment::where('company_id', $company->id)->orderByDesc('created_at')->get();
        $projects = ProductionProject::where('company_id', $company->id)->orderByDesc('created_at')->get();

        return view('company.production.payments.index', compact('company', 'payments', 'projects'));
    }
