...
class PoliticalController extends Controller
{
    ...
    public function profiles()
    {
        ...
        $profiles = PoliticalProfile::where('customer_id', $user->id)->orderByDesc('created_at')->get();

        return view('userdashboard-new.political.profiles.index', compact('profiles'));
    }
    ...
    {
        $user = Auth::guard('customer')->user();
        $profile = PoliticalProfile::where('customer_id', $user->id)->findOrFail($id);
    ...
    {
        $user = Auth::guard('customer')->user();
        $services = PublicService::where('customer_id', $user->id)->orderBy('display_order')->orderByDesc('created_at')->get();

        return view('userdashboard-new.political.services.index', compact('services'));
    }
    ...
    {
        $user = Auth::guard('customer')->user();
        $service = PublicService::where('customer_id', $user->id)->findOrFail($id);
    ...
    {
        $user = Auth::guard('customer')->user();
        $projects = DevelopmentProject::where('customer_id', $user->id)->orderByDesc('created_at')->get();

        return view('userdashboard-new.political.projects.index', compact('projects'));
    }
    ...
    {
        $user = Auth::guard('customer')->user();
        $project = DevelopmentProject::where('customer_id', $user->id)->findOrFail($id);
    ...
    {
        $user = Auth::guard('customer')->user();
        $events = PublicEvent::where('customer_id', $user->id)->orderByDesc('event_date')->get();

        return view('userdashboard-new.political.events.index', compact('events'));
    }
    ...
    {
        $user = Auth::guard('customer')->user();
        $event = PublicEvent::where('customer_id', $user->id)->findOrFail($id);
    ...
    {
        $user = Auth::guard('customer')->user();
        $volunteers = PartyVolunteer::where('customer_id', $user->id)->orderByDesc('created_at')->get();

        return view('userdashboard-new.political.volunteers.index', compact('volunteers'));
    }
    ...
    {
        $user = Auth::guard('customer')->user();
        $volunteer = PartyVolunteer::where('customer_id', $user->id)->findOrFail($id);
    ...
    {
        $user = Auth::guard('customer')->user();
        $grievances = PublicGrievance::where('customer_id', $user->id)->orderByDesc('created_at')->get();

        return view('userdashboard-new.political.grievances.index', compact('grievances'));
    }
    ...
    {
        $user = Auth::guard('customer')->user();
        $grievance = PublicGrievance::where('customer_id', $user->id)->findOrFail($id);
    ...
    // =====================
    // Frontend Grievance Form
    // =====================

    public function grievanceForm(Request $request, $slug)
    {
        $customer = customer::where('slug', $slug)->firstOrFail();

        return view('frontend.political.grievance', compact('customer'));
    }

    public function storePublicGrievance(Request $request, $slug)
    {
        $customer = customer::where('slug', $slug)->firstOrFail();
        ...
        $grievance = PublicGrievance::create([
        ...
        return redirect()->route('political.grievance.thanks', ['slug' => $slug, 'grievanceId' => $grievance->id]);
    }

    public function grievanceThanks(Request $request, $slug, $grievanceId)
    {
        $customer = customer::where('slug', $slug)->firstOrFail();
        $grievance = PublicGrievance::where('customer_id', $customer->id)->findOrFail($grievanceId);

        return view('frontend.political.thanks', compact('customer', 'grievance'));
    }
