...
class SolarController extends Controller
{
    public function solutions()
    {
        ...
        $solutions = SolarSolution::where('customer_id', $user->id)->orderByDesc('created_at')->get();

        return view('userdashboard-new.solar.solutions.index', compact('solutions'));
    }
    ...
    {
        $user = Auth::guard('customer')->user();
        $solution = SolarSolution::where('customer_id', $user->id)->findOrFail($id);
    ...
    {
        $user = Auth::guard('customer')->user();
        $surveys = SolarSiteSurvey::where('customer_id', $user->id)->orderByDesc('created_at')->get();

        return view('userdashboard-new.solar.surveys.index', compact('surveys'));
    }
    ...
    {
        $user = Auth::guard('customer')->user();
        $survey = SolarSiteSurvey::where('customer_id', $user->id)->findOrFail($id);
    ...
    {
        $user = Auth::guard('customer')->user();
        $projects = SolarProject::where('customer_id', $user->id)->orderByDesc('created_at')->get();

        return view('userdashboard-new.solar.projects.index', compact('projects'));
    }
    ...
    {
        $user = Auth::guard('customer')->user();
        $project = SolarProject::where('customer_id', $user->id)->findOrFail($id);
    ...
    {
        $user = Auth::guard('customer')->user();
        $subsidies = SubsidyApplication::where('customer_id', $user->id)->orderByDesc('created_at')->get();
        $projects = SolarProject::where('customer_id', $user->id)->orderByDesc('created_at')->get();

        return view('userdashboard-new.solar.subsidies.index', compact('subsidies', 'projects'));
    }
    ...
    {
        $user = Auth::guard('customer')->user();
        $subsidy = SubsidyApplication::where('customer_id', $user->id)->findOrFail($id);
    ...
    public function deleteSubsidy($id)
    {
        $user = Auth::guard('customer')->user();
        $subsidy = SubsidyApplication::where('customer_id', $user->id)->findOrFail($id);
        $subsidy->delete();
    ...
    {
        $user = Auth::guard('customer')->user();
        $monitoring = SolarMonitoring::where('customer_id', $user->id)->orderByDesc('created_at')->get();
        $projects = SolarProject::where('customer_id', $user->id)->orderByDesc('created_at')->get();

        return view('userdashboard-new.solar.monitoring.index', compact('monitoring', 'projects'));
    }
    ...
    {
        $user = Auth::guard('customer')->user();
        $entry = SolarMonitoring::where('customer_id', $user->id)->findOrFail($id);
        $entry->delete();
    ...
    {
        $user = Auth::guard('customer')->user();
        $amcPlans = SolarAmc::where('customer_id', $user->id)->orderByDesc('created_at')->get();
        $projects = SolarProject::where('customer_id', $user->id)->orderByDesc('created_at')->get();

        return view('userdashboard-new.solar.amc.index', compact('amcPlans', 'projects'));
    }
    ...
    {
        $user = Auth::guard('customer')->user();
        $amc = SolarAmc::where('customer_id', $user->id)->findOrFail($id);
        $amc->delete();
    ...
    public function surveyForm(Request $request, $slug)
    {
        ...
        return view('frontend.solar.survey', compact('customer'));
    }
    ...
    public function storePublicSurvey(Request $request, $slug)
    {
        ...
        return redirect()->route('solar.survey.thanks', ['slug' => $slug, 'surveyId' => $survey->id]);
    }

    public function surveyThanks(Request $request, $slug, $surveyId)
    {
        $customer = customer::where('slug', $slug)->firstOrFail();
        $survey = SolarSiteSurvey::where('customer_id', $customer->id)->findOrFail($surveyId);

        return view('frontend.solar.thanks', compact('customer', 'survey'));
    }
